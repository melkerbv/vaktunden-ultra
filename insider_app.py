...
# --- SÄKER DESIGN (Endast knappar och rubriker) ---
st.markdown("""
<style>
...
if st.session_state.auth['in']:
    ...
    <div style='text-align: center; margin-top: 100px;'>
        <h1 style='font-size: 4em; letter-spacing: 3px;'>🐺 VAKTHUNDEN</h1>
        <p style='font-size: 1.3em; margin-top: -10px;'>Algoritmisk marknadsbevakning och insideranalys.</p>
        <div style='margin-top: 40px; padding: 20px; border: 1px solid #30363d; border-radius: 8px; display: inline-block;'>
