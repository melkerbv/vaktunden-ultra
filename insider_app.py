...
def init_db():
    ...
    c.execute('''CREATE TABLE IF NOT EXISTS users(
                 ...
                 is_verified INTEGER DEFAULT 1, verification_code TEXT)''') # is_verified är nu alltid 1
...
# --- 6. HUVUDINNEHÅLL (DIREKT TILL TERMINALEN) ---
